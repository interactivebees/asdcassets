...
(function ($) {
    $.alert_ext = {
        ...
        // 提示框模版
        tmpl: '<div class="removeMargin alert alert-dismissable ${State}"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><h4 style="white-space: nowrap;">${Title}</h4><p>${Content}</p></div>',
        ...
        create: function (msg) {
            ...
            this.alertDiv.insertAfter($('.message'));
        },
